 ...
 */
public class FP1PracticalExampleAnswersTest {

    @Test
    public void shouldExtractAllPricesFromPurchase(){
        Purchase sut=preparePurchase();

        Collection<BigDecimal> result = FP1PracticalExampleAnswers.domainFunction.apply(sut);
    ...
    public void shouldSumCollectionOfBigDecimals(){
        ...
        BigDecimal result = FP1PracticalExampleAnswers.genericMathFunction.apply(bigDecimals);
