...
class ScalaFP1PracticalExampleCheck extends PropSpec with Matchers with PropertyChecks{
  ...
  import jug.lodz.workshops.old.fp1.exercises.ScalaFp1PracticalExample.DomainLib._
  import jug.lodz.workshops.old.fp1.exercises.ScalaFp1PracticalExample.MathLib
